      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="font-heading text-xl font-bold text-primary">TechTalent</h3>
            <p className="text-muted-foreground">
              Premium staffing solutions for prestigious software companies in India and the US.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li className="flex items-center space-x-2">
                ...
                <span className="text-muted-foreground">123 Tech Park, Bangalore, India</span>
              </li>
              <li className="flex items-center space-x-2">
              ...
              <li className="flex items-center space-x-2">
                ...
                <span className="text-muted-foreground">info@techtalent.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <p className="text-center text-muted-foreground text-sm">
            &copy; {new Date().getFullYear()} TechTalent Consultancy. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
