...
import { ArrowRight, Users, Building, Award, CheckCircle, Briefcase, User } from "lucide-react"
...
const testimonials = [
  {
    ...
    role: "CTO",
    quote:
      "TechTalent Consultancy has been instrumental in helping us build our engineering team. Their understanding of our technical requirements and company culture allowed them to find perfect matches for our open positions.",
  },
  {
    id: 2,
    name: "Rajesh Patel",
    ...
    quote:
      "We've worked with several staffing firms in the past, but none have delivered the quality of candidates that TechTalent has. Their screening process is thorough and they only send candidates who are truly qualified.",
  },
  {
    id: 3,
    name: "Michael Chen",
    ...
    role: "Director of HR",
    quote:
      "The team at TechTalent Consultancy understands the unique challenges of hiring in the tech industry. They've consistently provided us with top-tier talent that has helped drive our company forward.",
  },
]
    ...
    <>
      ...
      >
        <div className="flex flex-col md:flex-row gap-6 justify-center mt-8 max-w-2xl mx-auto">
          <Button asChild size="lg" className="text-base py-6 px-8 rounded-lg shadow-lg hover:shadow-xl transition-all">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          <div className="bg-white/80 backdrop-blur-sm p-6 rounded-lg shadow-md hover:shadow-lg transition-all">
            ...
            <p className="text-muted-foreground">
              Access to pre-vetted software professionals with proven expertise across all technology stacks.
            </p>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm p-6 rounded-lg shadow-md hover:shadow-lg transition-all">
            ...
            <p className="text-muted-foreground">
              Exclusive relationships with industry-leading software companies seeking exceptional talent.
            </p>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm p-6 rounded-lg shadow-md hover:shadow-lg transition-all">
            ...
            <p className="text-muted-foreground">
              Our rigorous matching process ensures cultural fit and technical alignment for lasting success.
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-12">
            <div className="glass p-6 rounded-lg text-center">
              ...
              <p className="text-muted-foreground">
                Access to a curated network of top-tier software professionals with verified skills and experience.
              </p>
            </div>
            ...
            <div className="glass p-6 rounded-lg text-center">
              ...
              <p className="text-muted-foreground">
                Strong relationships with prestigious software companies across India and the United States.
              </p>
            </div>
            ...
            <div className="glass p-6 rounded-lg text-center">
              ...
              <p className="text-muted-foreground">
                Consistent success in matching the right talent with the right opportunities for optimal outcomes.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mt-12">
            <div className="border rounded-lg p-6 hover:shadow-md transition-shadow">
              ...
              <p className="text-muted-foreground mb-4">
                Flexible staffing solutions for project-based needs, providing skilled professionals for short to
            ...
            <div className="border rounded-lg p-6 hover:shadow-md transition-shadow">
              ...
              <p className="text-muted-foreground mb-4">
                Strategic recruitment services to identify and secure top-tier talent for full-time positions within
                your organization.
              </p>
              <ul className="space-y-2 mb-6">
                <li className="flex items-start">
      ...
      <section className="py-20 bg-primary text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold font-heading mb-4">Ready to Find Your Perfect Match?</h2>
          <p className="text-xl text-white/90 max-w-2xl mx-auto mb-8">
            Whether you're looking for top talent or your next career opportunity, we're here to help.
          </p>
